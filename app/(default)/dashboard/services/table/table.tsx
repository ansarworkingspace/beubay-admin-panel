...
export function ServiceTable() {
    ...
    const { data: responseData, isLoading, error, isFetching, refetch } = useServices(page, limit, memoizedSearchParams);
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <DataTableToolbar
                    ...
                    url={`/dashboard/services/create?page=${currentPage}&limit=${currentLimit}`}
                            ...
                            {table.getRowModel().rows?.length ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={columns.length} className="h-24 text-center">
                                        <p className="text-muted-foreground">{hasActiveFilters ? "No matches." : "No services found."}</p>
                                    </TableCell>
                                </TableRow>
                            )}
                        </TableBody>
