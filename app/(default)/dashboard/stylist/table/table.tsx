...
import { useStylists } from "../controller";
...
export function StylistTable() {
    ...
    const { data: responseData, isLoading, error, isFetching, refetch } = useStylists(page, limit, memoizedSearchParams);
    ...
    const table = useReactTable<Stylist>({
        data: tableData,
        columns,
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <DataTableToolbar
                    ...
                    addTitle="Create Stylist"
                    url={`/dashboard/stylist/create?page=${currentPage}&limit=${currentLimit}`}
                            ...
                            {table.getRowModel().rows?.length ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={columns.length} className="h-24 text-center">
                                        <p className="text-muted-foreground">{hasActiveFilters ? "No matches." : "No stylists found."}</p>
                                    </TableCell>
                                </TableRow>
                            )}
                        </TableBody>
