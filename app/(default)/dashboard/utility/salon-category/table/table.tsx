...
import { useSalonCategories } from "../controller";
...
export function SalonCategoryTable() {
    ...
    const { data: responseData, isLoading, error, isFetching, refetch } = useSalonCategories(page, limit, memoizedSearchParams);
    ...
    const table = useReactTable<SalonCategoryData>({
        data: tableData,
        columns,
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <DataTableToolbar
                    ...
                    url={`/dashboard/utility/salon-category/create?page=${currentPage}&limit=${currentLimit}`}
