...
import { getServiceCategoryDetails } from "../../controller";
...
const ViewServiceCategory = () => {
    ...
    return (
        <FormContainer>
            <FormBreadcrumb items={["Dashboard", "Utility", "Service Categories", "View Details"]} />

            <div className="flex items-center justify-between mb-6">
                <div />
                <Button onClick={() => router.push(`/dashboard/utility/service-category/edit/${id}`)}>
