...
import { useStates } from "../controller";
...
const FIELD_MAPPING: Record<string, string> = {
    name: "name_like",
    state_code: "state_code_like",
    country_name: "country_name_like", // Assuming searching by country name partial match works
...
export function StateTable() {
    ...
    const {
        ...
        isFetching,
        refetch
    } = useStates(page, limit, memoizedSearchParams);
    ...
    const tableData = React.useMemo(() => statesResponse?.data || [], [statesResponse?.data]);

    const table = useReactTable<StateData>({
        data: tableData,
        columns,
        state: {
            sorting,
    ...
    const paginationInfo = statesResponse?.pagination;
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm text-gray-500">
                            Showing {tableData.length || 0} of {paginationInfo?.total || 0} states
                        </div>
                    </div>
                </div>
            </CardHeader>
